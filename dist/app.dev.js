...
var current = 0;
var myLibrary = [];
var one = nextORsubmit.innerHTML;
var objects = {
...
addORdisplay.addEventListener("click", function () {
  if (addORdisplay.innerHTML === objects.pen) {
    addORdisplay.innerHTML = objects.display;
    nextORsubmit.innerHTML = objects.submit;
...
nextORsubmit.addEventListener("click", function () {
  ...
  if (nextORsubmit.innerHTML === objects.submit) {
    addBook(title.value, author.value, pages.value, read.value);
    title.value = "";
    author.value = "";
    pages.value = "";
    read.value = "";
  } else if (nextORsubmit.innerHTML === objects.next && myLibrary.length !== 0) {
    var none = 0;
...
previusORreset.addEventListener("click", function () {
  ...
  if (previusORreset.innerHTML === objects.reset) {
    title.value = "";
    author.value = "";
    pages.value = "";
    read.value = "";
  } else if (previusORreset.innerHTML === objects.prev && myLibrary.length !== 0) {
    var none = 0;
